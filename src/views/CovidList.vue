  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: '未痊癒確診 - 學生', value: 'confirmedCase.studentTotal', align: 'center' },
        { text: '未痊癒確診 - 學生 - 臺北', value: 'confirmedCase.studentZoneDetail.Taipei', align: 'center' },
        { text: '未痊癒確診 - 學生 - 三峽', value: 'confirmedCase.studentZoneDetail.Sanxia', align: 'center' },
        { text: '未痊癒確診 - 老師', value: 'confirmedCase.teacher', align: 'center' },
        { text: '未痊癒確診 - 職員', value: 'confirmedCase.staff', align: 'center' },
